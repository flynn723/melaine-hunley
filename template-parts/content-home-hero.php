...
$feat_img_url = wp_get_attachment_url( get_post_thumbnail_id( $page_id ) );

$sub_title = ( class_exists('acf') ) ? get_field( 'sub_title', $page_id ) : "Install Advanced Custom Fields plugin.";
?>
<!-- Full Page Intro -->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 white-text text-center wow fadeInDown" data-wow-delay="0.3s">
          ...
          <h3 class="text-uppercase white-text font-family-spinmaker"><em><?php echo $sub_title; ?></em></h3>
        </div>
      </div>
