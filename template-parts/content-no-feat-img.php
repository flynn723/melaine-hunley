	...
	<div class="row">
		<div class="col text-center">
			<?php if ( is_archive() ) {
				...
				<?php if ( $parent_term->description ) : ?>
					<h3 class="text-uppercase heading-secondary mb-0" ><?php echo $parent_term->description; ?></h3>
				<?php endif; ?>
			<?php } else { ?>
				<h1 class="font-family-pinyon" ><?php the_title(); ?></h1>
				<?php if ( $sub_title ) : ?><h3 class="text-uppercase heading-secondary mb-0" ><?php echo $sub_title; ?></h3><?php endif; ?>
			<?php } ?>
		</div>
	</div>
</div>