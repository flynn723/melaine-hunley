    ...
    <div class="container">
      ...
      <div class="row mb-3">
        <div class="col text-center">
          <h4 class="text-uppercase font-family-rosarivo"><?php echo $parent_term->name; ?> Categories</h4>
        </div>
      </div>
      ...
      <div class="row row-eq-height fadeIn wow">
        ...
        foreach ( $child_terms as $term_id ) {
          ...
          <div class="col col-md-6 col-xl-3 mb-5">
            ...
            <!-- Card -->
            <div class="card card-gallery-category-<?php echo $term_id; ?> h-100">
              <?php
              if ( $term_img ) { ?>
                <!-- Card image -->
              ...
              <div class="card-body text-center">
                ...
                <?php } ?>
                <a href="<?php echo $this_term_permalink; ?>" title="<?php echo $this_term->name; ?>" class="btn btn-outline-black px-0 w-100 ml-0">Read More...</a>
              </div>
